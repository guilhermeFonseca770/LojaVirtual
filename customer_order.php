...
<html>
	<head>
		<meta charset="UTF-8">
		<title>Flowers Store ❀ HISTORICO DE PEDIDOS</title>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand">Flowers Store</a>
			</div>
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Nome</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													<tr><td>Produto</td><td><b><?php echo  CURRENCY." ".$row["product_price"]; ?></b></td></tr>
													<tr><td>Quantidade</td><td><b><?php echo $row["qty"]; ?></b></td></tr>
													<tr><td>Transação ID</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
